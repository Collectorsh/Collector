        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto sm:my-12 p-4 shadow-lg bg-white dark:bg-black dark:text-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-6">
              ...
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/dhdy10p82ndbmq5uj10dhdyvudybqves.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
              ...
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/6bgmz4zt59su1ekgy2sui16bgmz81dxo.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
              ...
              <div className="text-center">
                ...
                <p className="text-sm mt-2">Editions: 8</p>
              </div>
              <div className="text-center">
                <img
              ...
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/i38t3ngsi512ll318i38t37rbmlp3gkr.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
              ...
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/h4oazkg1k558y4h4oazkvg0gg38w6ult.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
              ...
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/0o1ybvhb8vt95n5po50dc9r0o1yb14jq.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
              ...
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/a1oemy4hf3jx26zl3w3a1oglgqm6kwk2.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
              ...
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/xbubnwelsoliitzc2g00xbubnwelds8i.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
                <p className="font-bold">Kamal Hasan</p>
                <p className="underline">The Sinned Light</p>
                <p className="text-sm mt-2">Editions: 10</p>
              </div>
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/b6k99wca950mc9qzb6k99wuhptyseqtz.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
                <p className="font-bold">Faiq</p>
                <p className="underline">SYMMETRICALLY ASYMMETRICAL</p>
                <p className="text-sm mt-2">Editions: 1</p>
              </div>
              <div className="text-center">
                <img
                  src="/images/drops/hanaknight/2b2g6nyvb3g51pgvh422b2g6yhoao001.jpg"
                  className="w-full h-96 lg:h-64 object-center object-cover"
                />
                <p className="font-bold">tigerpunks</p>
                <p className="underline">View At Snowy Road III</p>
                <p className="text-sm mt-2">Editions: 1</p>
              </div>
              <div className="text-center">
                <img
