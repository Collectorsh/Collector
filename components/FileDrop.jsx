...
const FileDrop = ({
  ...
  return (
    ...
    {({ getRootProps, getInputProps }) => (
        <section className='w-full h-fit md:h-full border-2 border-dashed border-neutral-200 dark:border-neutral-700 rounded-lg overflow-y-auto relative'>
        <div {...getRootProps()} className='w-full h-fit md:h-full flex flex-col gap-2 justify-center items-center relative cursor-pointer'>
          <input {...getInputProps()} />
