export default function FormfunctionLogo({ color }) {
  return (
    <>
      <span>
        <svg
          ...
          fill={color}
          className={`${
            color ? `fill-${color} inline` : "fill-black dark:fill-white inline"
          }`}
        >
          <path
            fillRule="evenodd"
      ...
      <span
        className={`${
          color
            ? `text-${color} ml-1 text-sm`
            : "text-black dark:text-white ml-1 text-sm"
        }`}
      >
        Formfunction
      </span>
