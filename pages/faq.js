    ...
    <div className="dark:bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="px-4 xl:px-0">
          ...
          <p>
            Collector is an art platform curated by the community that makes its
            easy to discover, collect, and share beautiful art.
          </p>
          ...
          <ul>
            ...
            <li>Approve the Signature Request to prove ownership</li>
          ...
          <ul>
            ...
            <li>You can now view your gallery at collector.sh/yourname</li>
            <li>beautiful art deserves to be shared</li>
            <li>NFT must be in one of your connect wallets</li>
            <li>
              Listing your NFT on a marketplace that uses custodial contracts
              will remove the NFT from your gallery
            </li>
          </ul>
          ...
          <ul>
            <li>
              First off, you don’t need to do anything in order to be follow on
              Collector
            </li>
            <li>Claim your profile</li>
            <li>
              Curate a gallery of your own work or feature pieces that you’ve
              collected
            </li>
            <li>Sell your NFTs</li>
          </ul>
          ...
          <ul>
            ...
            <li>Find the NFT that you want to sell and click ‘List’</li>
            <li>
          ...
          <p className="mb-12">
            Every Collector participates and contributes to the site by
            interacting with marketplaces and the blockchain
          </p>
        </div>
      </div>
    </div>
