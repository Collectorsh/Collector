...
const CurationName = ({ name, displayPublishedEdit, setEditNameOpen }) => { 
  return (
    <div className={clsx(
      "group/name mb-0 mx-auto w-full rounded-lg border-4 border-transparent",
      displayPublishedEdit && "duration-300 border-dashed border-neutral-200/60 dark:border-neutral-700/60 hover:border-neutral-200 hover:dark:border-neutral-700",
    )}>
      <EditWrapper
