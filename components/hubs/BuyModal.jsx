...
export default function BuyModal({ open, token, closeModal }) {
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      ...
                      <button
                        className="w-full mt-4 bg-white border border-4 border-black text-black rounded-lg px-3 py-3 hover:bg-neutral-100"
                        name="buy"
                        onClick={closeModal}
                      >
                        <span>Nevermind</span>
