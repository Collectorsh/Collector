...
import { Collapse } from "/components/wallet/Collapse";
import { WalletSVG } from "/components/wallet/WalletSVG";
  ...
  const getStartedWallet = useMemo(() => {
    return installedWallets.length
      ? // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        installedWallets && installedWallets[0]
