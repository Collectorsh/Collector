  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        <Dialog.Panel className="relative p-4 md:p-8 mx-auto w-full max-w-screen-lg rounded-lg bg-white dark:bg-dark2 text-black dark:text-neutral-200">
          <button
          ...
          <br />
          <p className="mb-6">This only needs to be done once and it usually takes less than a second per artwork. However, if there are large file sizes or if your collection is large it could take several minutes. Thank you for your patience!</p>
